...
import (
	...
	"infini.sh/coco/lib/langchaingo/llms/googleai"
	"infini.sh/coco/lib/langchaingo/llms/googleai/vertex"
)
...
func testMultiContentImageLink(t *testing.T, llm llms.Model) {
	...
	parts := []llms.ContentPart{
		llms.ImageURLPart(
			"https://infini.sh/coco/lib/langchaingo/blob/main/docs/static/img/parrot-icon.png?raw=true",
		),
