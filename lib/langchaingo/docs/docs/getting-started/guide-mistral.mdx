...
```shell
go run infini.sh/coco/lib/langchaingo/examples/mistral-completion-example@main
```
...
Here is the entire program (from [mistral-chat-example](https://infini.sh/coco/lib/langchaingo/blob/main/examples/mistral-chat-example/mistral_chat_example.go)).
