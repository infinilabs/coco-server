...
```shell
go run infini.sh/coco/lib/langchaingo/examples/openai-completion-example@main
```
...
Here is the entire program (from [openai-completion-example](https://infini.sh/coco/lib/langchaingo/blob/main/examples/openai-completion-example/openai_completion_example.go)).
