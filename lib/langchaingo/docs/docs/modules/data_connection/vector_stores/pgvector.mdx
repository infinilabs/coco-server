...
Here is the entire program (from [pgvector-vectorstore-example](https://infini.sh/coco/lib/langchaingo/blob/main/examples/pgvector-vectorstore-example/pgvector_vectorstore_example.go)):
