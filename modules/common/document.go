...
type Document struct {
	...
	Owner         string            `json:"owner,omitempty" elastic_mapping:"owner:{type:keyword,copy_to:combined_fulltext}"`      // Document author or owner
	...
	Metadata      map[string]string `json:"metadata,omitempty" elastic_mapping:"metadata:{type:flattened}"`   // Additional source-specific metadata (e.g., file version, permissions)
