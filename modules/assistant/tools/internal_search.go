...
func InitialDocumentBriefSearch(ctx context.Context, userID string, reqMsg, replyMsg *core.ChatMessage,
	...
	docs := []core.Document{}
	_, err := document.QueryDocuments(ctx, builder, reqMsg.Message, params.Datasource, params.IntegrationID, params.Category, params.Subcategory, params.RichCategory, "semantic", 3, &docs)
	if err != nil {
		log.Error(err)
		return nil, err
	}
