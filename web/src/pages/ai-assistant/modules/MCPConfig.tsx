    ...
    <Space direction="vertical" className='w-600px mt-[5px]'>
      ...
      <div>
        <Space direction="vertical">
          <p className="text-[#999] mt-10px">{t('page.assistant.labels.max_iterations')}</p>
          <InputNumber min={1} max={100} value={value.max_iterations || 5} onChange={onMaxIterationsChange} defaultValue={5} />
        </Space>
      </div>
      <div>
        <Space direction="vertical">
          <p className="text-[#999] mt-10px">{t('page.assistant.labels.caller_model')}</p>
          <ModelSelect
            value={value.model}
