const page: App.I18n.Schema['translation']['page'] = {
  ...
  assistant: {
    ...
    labels: {
      ...
      role_prompt: 'Role Prompt Template',
  ...
  datasource: {
    ...
    connect: 'Connect',
    missing_config_tip:
      '{{name}} authorization parameters are not configured. Please set them before connecting. Click Confirm to go to the settings page.',
    delete: {
