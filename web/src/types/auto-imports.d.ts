...
declare global {
  ...
  const ApplyTrial: typeof import('../components/License/ApplyTrial.jsx')['default']
  ...
  const Code: typeof import('../components/License/Code.jsx')['default']
  ...
  const DateTime: typeof import('../components/DateTime/index')['default']
  const DocumentDrawer: typeof import('../components/DocumentDrawer/index')['default']
  const DragContent: typeof import('../components/advanced/DragContent')['default']
  const EULA: typeof import('../components/License/EULA.jsx')['default']
  ...
  const LicenseInfo: typeof import('../components/License/LicenseInfo.jsx')['default']
  ...
  const Markdown: typeof import('../components/DocumentDrawer/Markdown.jsx')['default']
  ...
  const displayDate: typeof import('../components/DateTime/index')['displayDate']
  const fontIcon: typeof import('../components/common/font_icon.jsx')['default']
  const formatDate: typeof import('../components/DateTime/index')['formatDate']
  const forwardRef: typeof import('react')['forwardRef']
  const getEndpoint: typeof import('../components/micro/utils')['getEndpoint']
  const getName: typeof import('../components/micro/utils')['getName']
  const getProxyEndpoint: typeof import('../components/micro/utils')['getProxyEndpoint']
  ...
  const setupMicro: typeof import('../components/micro/index')['setupMicro']
