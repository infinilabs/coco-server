 ...
 * @returns Hex color
 */
export function getAntDPaletteColorByIndex(color: string, index: number) {
 ...
 */
export function getAntDColorPalette(color: string, darkTheme = false, darkThemeMixColor = '#141414') {
 ...
 */
function getHue(hsv: { h: number; s: number; v: number }, i: number, isLight: boolean) {
  let hue;
 ...
 * @param isLight - Is light color
 */
function getSaturation(hsv: { h: number; s: number; v: number }, i: number, isLight: boolean) {
  if (hsv.h === 0 && hsv.s === 0) {
    return hsv.s;
  }
 ...
 * @param isLight - Is light color
 */
function getValue(hsv: { h: number; s: number; v: number }, i: number, isLight: boolean) {
  let value;
