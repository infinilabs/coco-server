 ...
 */
function getCssVarByTokens(tokens: Record<string, Record<string, string>>, prefix = '') {
  const styles: string[] = [];
 ...
 * @param tokens
 */
export function addThemeVarsToGlobal(tokens: Record<string, Record<string, string>>, darkTokens: Record<string, Record<string, string>>, prefix = '', container?: Element | ShadowRoot | null) {
...
export function updateDarkMode(themeScheme: string) {
  if (themeScheme === 'dark') {
    return true;
