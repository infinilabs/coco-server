...
// ExtractDominantColors extracts the top 3 dominant colors from an image and
// returns them as lowercase English color names.
...
// mapHexToColorName returns the closest predefined English color name for a hex string.
