...
```shell
//request
curl  -H 'Content-Type: application/json'   -XPOST http://localhost:2900/datasource/ -d'
{
    "name":"My Hugo Site",
    "type":"connector",
    "connector":{
...
```shell
//request
curl  -H 'Content-Type: application/json'   -XDELETE http://localhost:2900/datasource/cu1rf03q50k43nn2pi6g -d'
{
  "_id": "cu1rf03q50k43nn2pi6g",
  "result": "deleted"
}'
